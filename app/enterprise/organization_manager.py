...
class OrganizationManager:
    ...
    async def invite_user(
        ...
        try:
            ...
            self.db.rollback()
            logger.error(
                "user_invitation_failed", error=str(e), org_id=organization_id, email=email
            )
            raise
    ...
    async def create_api_key(
        ...
        try:
            ...
            if current_keys >= org.max_api_keys:
                raise ValueError(
                    f"Organization has reached maximum API key limit ({org.max_api_keys})"
                )
    ...
    async def check_organization_limits(
        ...
        try:
            ...
            limits_status = {"within_limits": True, "warnings": [], "errors": []}
